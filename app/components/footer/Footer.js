...
const Footer = () => {
  return (
    <footer className="flex justify-center border-t border-white/10 bg-black text-white">
      <div className="w-full flex max-w-7xl flex-col gap-10 !p-6 py-12 md:flex-row md:items-center md:justify-between">
        {/* Left Side */}
          ...
          <div className="flex justify-end  items-center gap-3 pt-2">
            {[
              ...
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-gray-300 transition-all duration-300 hover:border-[#916CE7] hover:bg-[#916CE7] hover:text-black"
              >
                {item.icon}
              </a>
            ))}
